...
apt install --no-install-recommends -y git clang lld valgrind gnulib cmake ninja-build python-is-python3 clang libzstd1 zlib1g-dev libzstd-dev po4a doxygen flex libelf-dev bc cpio libssl-dev openssl zstd kmod fontforge perl libfont-ttf-perl libtool-bin
